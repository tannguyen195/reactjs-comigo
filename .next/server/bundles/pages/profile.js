...
function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function renderBadge() {
      var userBadge = this.props.userBadge;
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement("div", {
      ...
      }, userData.firstName + " " + userData.lastName), userData.graduationYear && external__react__default.a.createElement("div", {
        className: "Body-Dark-Grey-Center"
      }, userData.graduationYear > 2019 ? "Graduating in " : "Graduated in ", " ", userData.graduationYear), external__react__default.a.createElement("div", {
        className: "Body-Black-Center info__bio"
      }, userData.bio), external__react__default.a.createElement("div", {
        ...
        className: "Button-Black-Center"
      }, "Edit Profile"))), external__react__default.a.createElement(button__default.a, {
        type: "danger",
        className: "Button-Black-Center",
        onClick: handleLogout
      }, "Sign out"))), external__react__default.a.createElement("div", {
        className: "tag"
      }, external__react__default.a.createElement("div", {
        className: "tag__type H3-Black-Left"
      }, "Majors"), external__react__default.a.createElement("div", {
        className: "tag__content"
      }, " ", userData.majors && userData.majors.map(function (item, index) {
        ...
        className: "tag__content"
      }, " ", userData.skills && userData.skills.map(function (item, index) {
        return external__react__default.a.createElement(button__default.a, {
          key: index,
          className: "Body-Dark-Grey-Center"
        }, item);
        ...
        className: "tag__content"
      }, " ", userData.interests && userData.interests.map(function (item, index) {
        return external__react__default.a.createElement(button__default.a, {
          key: index,
          className: "Body-Dark-Grey-Center"
        }, item);
      ...
      }, "My Badges"), userBadge && external__react__default.a.createElement("div", {
        className: "badge__container"
      }, this.renderBadge())), external__react__default.a.createElement("section", {
        className: "projects"
      }, external__react__default.a.createElement("div", {
        className: "H3-Black-Left"
      }, "Projects"), userData.projects && external__react__default.a.createElement("div", {
        ...
        className: "H3-Black-Left"
      }, "My Links"), userData.links && external__react__default.a.createElement("div", {
        className: "links__container"
      }, userData.links.map(function (item, index) {
...
// EXTERNAL MODULE: ./src/components/profile/_profile.less
var _profile = __webpack_require__(137);
var _profile_default = /*#__PURE__*/__webpack_require__.n(_profile);
...
// CONCATENATED MODULE: ./src/components/profile/ProfileContainer.js
function ProfileContainer__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { ProfileContainer__typeof = function _typeof(obj) { return typeof obj; }; } else { ProfileContainer__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return ProfileContainer__typeof(obj); }

function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }

function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { ProfileContainer__defineProperty(target, key, source[key]); }); } return target; }

function ProfileContainer__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function ProfileContainer__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function ProfileContainer__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function ProfileContainer__createClass(Constructor, protoProps, staticProps) { if (protoProps) ProfileContainer__defineProperties(Constructor.prototype, protoProps); if (staticProps) ProfileContainer__defineProperties(Constructor, staticProps); return Constructor; }

function ProfileContainer__possibleConstructorReturn(self, call) { if (call && (ProfileContainer__typeof(call) === "object" || typeof call === "function")) { return call; } return ProfileContainer__assertThisInitialized(self); }

function ProfileContainer__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

function ProfileContainer__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var ProfileContainer_ProfileContainer =
/*#__PURE__*/
function (_Component) {
  ProfileContainer__inherits(ProfileContainer, _Component);

  function ProfileContainer(props) {
    var _this;

    ProfileContainer__classCallCheck(this, ProfileContainer);

    _this = ProfileContainer__possibleConstructorReturn(this, (ProfileContainer.__proto__ || Object.getPrototypeOf(ProfileContainer)).call(this, props));
    Object.defineProperty(ProfileContainer__assertThisInitialized(_this), "handleLogout", {
      configurable: true,
      enumerable: true,
      writable: true,
  ...
  ProfileContainer__createClass(ProfileContainer, [{
    key: "componentWillReceiveProps",
    value: function componentWillReceiveProps(nextProps) {
      var badgeList = nextProps.badgeList,
          userData = nextProps.userData;

      if (userData && badgeList) {
        var temp = badgeList;
        badgeList.map(function (item, index) {
          if (external__lodash__default.a.find(userData.nods, ['badgeID', item._id])) {
            temp[index] = _objectSpread({}, temp[index], {
              count: external__lodash__default.a.find(userData.nods, ['badgeID', item._id]).count
            });
          }
        });
        this.setState({
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement("div", null, external__react__default.a.createElement("style", {
        dangerouslySetInnerHTML: {
          __html: _profile_default.a
        }
      }), external__react__default.a.createElement(head["a" /* default */], {
        title: "Your portfolio"
      }), userData && external__react__default.a.createElement(Profile__default, _extends({}, this.state, this.props, {
...
/* harmony default export */ var profile_ProfileContainer = (Object(external__react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(ProfileContainer_ProfileContainer));
// CONCATENATED MODULE: ./pages/profile.js

/* harmony default export */ var profile = __webpack_exports__["default"] = (profile_ProfileContainer);
